    ...
    res.json().then((data3) => {
      ...
      if (((_a = data3.values) == null ? void 0 : _a.length) > 0) {
        combinedSolarData.push(...data3.values.map((r) => {
          return {
            x: referenceDay(r[0] * 1e3).valueOf(),
            //Prometheus uses seconds so convert to milliseconds for js
